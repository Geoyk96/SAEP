...
parser.add_argument('-f', '--data_file', type=str, default='data/twitter_data.npy', help='path of input file')
parser.add_argument('-n', '--social_network', type=str, default='data/twitter_network.pkl', help='path of network file')
parser.add_argument('-o', '--output_file', type=str, default='data/predict_twitter.npy', help='path of output file')
...
parser.add_argument('-d', '--dropout', type=float, default=0.9, help='the dropout rate of output layers, default value is 0.8')
...
for epoch in range(num_epochs):
    ...
    for i, (i_data, i_mask, i_interval, i_length, u_all, m_in, m_out, m_all, n_input, n_inter, n_len) in enumerate(train_loader):
        ...
        loss_all += loss
        num_all += num
    print('train epoch {} mse:'.format(epoch),
